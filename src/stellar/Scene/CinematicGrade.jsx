 ...
 * white).
 *
 * The fix: do all three grades (brightness/contrast, saturation,
 * vignette) inside ONE Effect → only ever one mainImage in the merged
 * pass → no merge bug. Bloom stays a separate convolution pass (it never
 * merges with mainImage effects), so it's unaffected.
 *
