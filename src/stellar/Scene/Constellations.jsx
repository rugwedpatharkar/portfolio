...
const CONSTELLATIONS = [
  ...
  },
  {
    ...
    stars: [
      ...
      /* 2 Gienah (ε Cyg)  */ [20.7702, 33.970], // east wing
      /* 3 Albireo (β Cyg) */ [19.5119, 27.960], // the head
      /* 4 Fawaris (δ Cyg) */ [19.7496, 45.131], // west wing
    ],
    edges: [[0,1],[1,3],[4,1],[1,2]],
  },
  {
    name: "Scorpius",
    stars: [
      ...
      /*10 Shaula (λ) */ [17.5601, -37.104], // the stinger
