...
const SPEED = 130, BOOST = 3.2, BOUNDS = 6500, LOOK_SENS = 0.0022, PITCH_MAX = 1.45, FOV = 72;
const CENTER = new THREE.Vector3(0, 0, 0); // true-scale system spans ~0..6000 from the Sun
