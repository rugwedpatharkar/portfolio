  ...
  return (
    <button
      ...
      style={{
        ...
        background: down ? (accent || "rgba(0,206,168,0.34)") : "rgba(255,255,255,0.06)",
...
const ModeSwitch = ({ pilot, onToggle, disabled }) => (
  ...
  >
    <span style={{ padding: "4px 7px", borderRadius: 6, color: pilot ? "rgba(255,255,255,0.5)" : "#fff", background: pilot ? "transparent" : "rgba(145,94,255,0.4)" }}>◉ LOCK</span>
    <span style={{ padding: "4px 7px", borderRadius: 6, color: pilot ? "#fff" : "rgba(255,255,255,0.5)", background: pilot ? "rgba(0,206,168,0.4)" : "transparent" }}>✈ FREE</span>
  </button>
);
  ...
  return (
    <div
      style={{
        ...
        border: `1px solid ${pilot ? "rgba(0,206,168,0.4)" : "rgba(255,255,255,0.1)"}`,
