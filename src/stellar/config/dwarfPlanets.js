 ...
 * Radii are ordered by TRUE diameter and capped just under Pluto's real
 * true-scale radius (0.034u, the LARGEST dwarf): Eris — really a hair smaller
 * than Pluto — tops out at 0.033, and everything ranks down from there, with a
 * ~0.016u floor so sub-km bodies still read. (A flat visibility floor used to
 * make every background dwarf render BIGGER than Pluto, inverting the ranking.)
 * Positions sit within the asteroid belt (~x19) and the Kuiper belt (~x44).
 */
...
const RAW = [
  ...
  // ── Main asteroid belt ──
  {
    id: "vesta", label: "Vesta", category: "Asteroid", position: [20.4, -0.6, -1.1], radius: 0.024, color: "#b8a98c", // ~525 km
  ...
  {
    id: "pallas", label: "Pallas", category: "Asteroid", position: [20.7, 2.2, -1.6], radius: 0.023, color: "#9aa4ac", // ~512 km
  ...
  {
    id: "hygiea", label: "Hygiea", category: "Asteroid", position: [21.5, -0.9, 1.9], radius: 0.022, color: "#5e5852", // ~434 km
  ...
  {
    id: "psyche", label: "16 Psyche", category: "Metal asteroid", position: [20.9, 0.9, 1.4], radius: 0.021, color: "#9a9082", // ~223 km
  ...
  {
    id: "makemake", label: "Makemake", category: "Dwarf planet", position: [42.3, 1.9, -1.7], radius: 0.029, color: "#caa98a", // 1,430 km
  ...
  {
    id: "arrokoth", label: "Arrokoth", category: "Kuiper object", position: [45.6, 0.8, 1.7], radius: 0.018, color: "#8a5a44", // ~36 km long — near the floor
  ...
  {
    id: "gonggong", label: "Gonggong", category: "Dwarf planet", position: [53, -2.6, 3.1], radius: 0.028, color: "#9a5a4a", // ~1,230 km
  ...
  {
    id: "orcus", label: "Orcus", category: "Dwarf planet", position: [44.5, 2.3, 2.6], radius: 0.025, color: "#bcc6cc", // ~910 km
