...
export const ACHIEVEMENTS = [
  ...
  { id: "gas_giants", label: "Gas Giant Tour", icon: "◯", color: "#4da6ff",
    hint: "See Jupiter, Saturn, Uranus, and Neptune." },
  { id: "edge_beacon", label: "Edge Beacon", icon: "▲", color: "#ff6b6b",
    hint: "Reach the heliopause." },
  { id: "all_destinations", label: "Solar Tourist", icon: "✦", color: "#2fe0b0",
    hint: "Visit all 12 destinations." },
  { id: "konami", label: "Konami Decoded", icon: "🛸", color: "#ffb84d",
    hint: "↑↑↓↓←→←→ba" },
