    ...
    <div ref={ref}>
      ...
      >
        ...
        <div className="glass-card-dark rounded-t-none rounded-b-xl p-4 sm:p-6 overflow-x-auto min-h-[280px] sm:min-h-[380px]">
          <div className="font-mono text-caption sm:text-body leading-relaxed">
            {CODE_LINES.slice(0, visibleLines).map((line, i) => (
              <div key={i} className="flex" style={{ animation: "fadeInLine 0.15s ease forwards" }}>
                <span className="w-8 sm:w-10 text-right pr-3 sm:pr-4 text-white/20 select-none text-caption sm:text-body-sm shrink-0">
                  {i + 1}
                </span>
...
export default SectionWrapper(LiveCodeShowcase, "showcase", "Showcase");
