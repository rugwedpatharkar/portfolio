...
const FloatingActionMenu = () => {
  ...
  const toggleCinema = () => {
    const next = !cinemaActive;
    setCinemaActive(next);
    window.dispatchEvent(new CustomEvent("cinema-mode", { detail: next }));
    setOpen(false);
  };
  ...
  const actions = [
    ...
    {
      label: cinemaActive ? "Exit Cinema (\\ )" : "Cinema Mode (\\ )",
      onClick: toggleCinema,
      icon: <CinemaIcon />,
      color: cinemaActive ? "#f8c555" : "#334155",
    },
    {
