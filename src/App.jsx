...
const BootReveal = () => (
  <div style={{ position: "fixed", inset: 0, zIndex: 9999, background: "#050609", display: "flex", alignItems: "center", justifyContent: "center" }}>
    <div style={{ fontFamily: "'Syne', system-ui, sans-serif", fontWeight: 340, fontSize: "clamp(1.5rem, 5vw, 2.4rem)", letterSpacing: "-.01em", color: "#f5f7fc", opacity: 0, animation: "stellarBoot 700ms cubic-bezier(.22,1,.36,1) forwards" }}>
  ...
  return (
    <main id="main-content" style={{ position: "fixed", inset: 0, overflow: "auto", background: "#050609", color: "#f5f7fc", display: "flex", alignItems: "center", justifyContent: "center", padding: 24, textAlign: "center" }}>
      <div style={{ maxWidth: 560 }}>
        ...
        <h1 style={{ font: "400 clamp(2.2rem, 6vw, 3.4rem) 'Syne', system-ui, sans-serif", lineHeight: 1.05, letterSpacing: "-.02em", margin: "0 0 .4em" }}>
          Backend &amp; <em style={{ fontStyle: "italic", color: "#e9c675" }}>Agentic AI</em> Engineer
        </h1>
        <p style={{ font: "300 1.05rem 'Sora', system-ui, sans-serif", color: "#c4c8d6", lineHeight: 1.6, margin: "0 0 28px" }}>
        ...
        <div style={{ font: "400 1rem 'Sora', system-ui, sans-serif", display: "flex", gap: 22, justifyContent: "center", flexWrap: "wrap" }}>
